...
class DiscordSenderApp:
    ...
    def _build_main(self):
        ...
        tk.Scale(sw, from_=1, to=120, variable=self.interval_var,
            orient="horizontal", bg=BG2, fg=MUTED,
            troughcolor=BORDER, activebackground=ACCENT,
            highlightthickness=0, bd=0, showvalue=False,
            sliderrelief="flat", command=self._on_interval).pack(fill="x")
    ...
    def _build_token(self):
        ...
        for text in [
            "1. Открой свой профиль discord.com в браузере",
